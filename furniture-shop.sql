...
(1, 'Kavyashree',  'admin@gmail.com', 'Kavya@123','9632353935','logo.png');
...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  `cust_name` varchar(100) CHARACTER SET utf8mb4   NOT NULL,
  `cust_email` varchar(100) CHARACTER SET utf8mb4   NOT NULL,
  `cust_pass` varchar(100) CHARACTER SET utf8mb4   NOT NULL,
  `cust_add` varchar(200) CHARACTER SET utf8mb4  NOT NULL,
  `cust_city` varchar(50) CHARACTER SET utf8mb4   NOT NULL,
  `cust_postalcode` varchar(50) CHARACTER SET utf8mb4  NOT NULL,
  `cust_number` varchar(100) CHARACTER SET utf8mb4 NOT NULL,
  PRIMARY KEY (`cust_id`)
...
(1, 5, 'demo@gmail.com', 'demo', 'blore', 'blore', 54840, '03224987258', 39, 49800, 1637501531, 2, '23-08-2023', 'pending'),
(2, 5, 'demo@gmail.com', 'demo', 'blore', 'blore', 54840, '03224987258', 32, 65000, 1637501531, 1, '23-08-2023', 'pending'),
(3, 5, 'demo@gmail.com', 'demo', 'blore', 'blore', 54840, '03224987258', 34, 14600, 1637501531, 1, '23-08-2023', 'pending');
